...
<div class="toc">
	<ul>
    		<li><a href="#header-1">Day 1: Introduction to Labs, Synthesis and flop to total cell ratio</a></li>
		<ul>
        		<li><a href="#header-1-1"> Summary</a></li>
 		</ul>
		<ul>
			<li><a href="#header-1-2">Lab Introduction</a></li>
		</ul>
		<ul>
			<li><a href="#header-1-3">Synthesis and Flop Ratio</a></li>
		</ul>
 </div>
 <div class="toc">
  	<ul>
